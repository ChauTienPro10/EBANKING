/**
 * Face Liveness Camera Screen
 * Dedicated camera screen for Face Authentication
 * Reuses eKYC camera components with custom callbacks
 */
...
import CompleteView from '../ekyc/components/liveness-camera/CompleteView';
import CameraView from '../ekyc/components/liveness-camera/CameraView';

interface FaceLivenessCameraScreenProps {
  onVideoRecorded: (videoPath: string) => void;
  onBack: () => void;
}

const FaceLivenessCameraScreen: React.FC<FaceLivenessCameraScreenProps> = ({
  onVideoRecorded,
  onBack,
}) => {
  ...
  if (videoPath) {
    return <CompleteView onContinue={handleContinue} onRetake={retake} />;
  }
...
export default FaceLivenessCameraScreen;
